...
//    Performs BFS and returns the vector of moves done to solve the cube
    ...
    vector<RubiksCube::MOVE> solve() {
        ...
        assert(solved_cube.isSolved());    // Ensure that the solved cube is indeed solved
        ...
        rubiksCube = solved_cube;   // Update the current cube to the solved cube
        reverse(moves.begin(), moves.end()); // Reverse the moves to get the correct order
        return moves;
    }
